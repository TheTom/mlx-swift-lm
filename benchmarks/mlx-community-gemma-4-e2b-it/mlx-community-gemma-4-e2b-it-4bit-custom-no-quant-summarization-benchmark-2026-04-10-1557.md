...
|--------|---------------|---------------|-----------|---------------|-----------|------------|------|-----------|---------|-----------|---------|-------------|----------|----------|----------|--------|
| summarization | 4096 | 4088 | no-quant | 6895.2 | 185.7 | 200 | 594ms | — | — | — | — | 2.45GB | 3.32GB | 29MB | 938MB | This excerpt is a collection of fragmented passages from **F |
