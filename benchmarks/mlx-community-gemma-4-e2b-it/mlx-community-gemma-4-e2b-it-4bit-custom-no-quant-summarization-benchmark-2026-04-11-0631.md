...
**Date**: 2026-04-11 06:31
**Branch**: `feature/native-prefill-bridge`
...
|--------|---------------|---------------|-----------|---------------|-----------|------------|------|-----------|---------|-----------|---------|-------------|----------|----------|----------|--------|
| summarization | 1024 | 1008 | no-quant | 1966.2 | 132.8 | 200 | 513ms | — | — | — | — | 2.45GB | 7.43GB | 18MB | 264MB | This excerpt from *The Great Gatsby* details the **narrator' |
