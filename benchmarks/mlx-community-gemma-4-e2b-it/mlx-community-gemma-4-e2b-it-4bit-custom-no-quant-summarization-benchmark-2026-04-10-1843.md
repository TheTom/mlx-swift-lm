...
|--------|---------------|---------------|-----------|---------------|-----------|------------|------|-----------|---------|-----------|---------|-------------|----------|----------|----------|--------|
| summarization | 4096 | 4088 | no-quant | 7423.5 | 188.1 | 200 | 551ms | — | — | — | — | 2.45GB | 3.59GB | 24MB | 938MB | This excerpt is a collection of fragmented passages from **F |
