...
**Date**: 2026-04-10 22:58
**Branch**: `ek/tom-eric-moe-tuning`
**Commit**: `dfa6256 perf: correct native bridge + PrefillBench modes`
**Quantization**: custom
...
|--------|---------------|---------------|-----------|---------------|-----------|------------|------|-----------|---------|-----------|---------|-------------|----------|----------|----------|--------|
| summarization | 1024 | 1008 | no-quant | 2917.8 | 192.2 | 200 | 346ms | — | — | — | — | 2.45GB | 3.72GB | 8MB | 264MB | This excerpt from *The Great Gatsby* introduces a narrator w |
