...
|--------|---------------|---------------|-----------|---------------|-----------|------------|------|-----------|---------|-----------|---------|-------------|----------|----------|----------|--------|
| summarization | 4096 | 4088 | no-quant | 7109.0 | 187.1 | 200 | 576ms | — | — | — | — | 2.45GB | 3.32GB | 33MB | 938MB | This excerpt is a collection of fragmented pieces from **F.  |
