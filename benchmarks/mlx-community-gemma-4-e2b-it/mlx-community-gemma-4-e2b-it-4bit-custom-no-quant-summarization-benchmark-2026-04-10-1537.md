...
|--------|---------------|---------------|-----------|---------------|-----------|------------|------|-----------|---------|-----------|---------|-------------|----------|----------|----------|--------|
| summarization | 8192 | 8192 | no-quant | 5602.2 | 177.9 | 200 | 1463ms | — | — | — | — | 2.45GB | 3.34GB | 69MB | 1.79GB | This is an excerpt from **Nick Carraway's narration** in **T |
